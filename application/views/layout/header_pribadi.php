		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="<?= base_url('Mhs/pribadi') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Data Pribadi </span></a>
					</li>
                    <li class="nav-item">
					    <a href="<?= base_url('Mhs/edit_pribadi') ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-file-text"></i></span><span class="pcoded-mtext">Perbarui Data Pribadi </span></a>
					</li>
				</ul>
			</div>
		</div>
