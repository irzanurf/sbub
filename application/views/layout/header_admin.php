        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" style="background-image : linear-gradient(194deg,#5161E9 10%,#5161E9 100%);" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <span>Daftar SBUB</span>
                </a>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Angkatan:</h6>
                        <a class="collapse-item" href="<?= base_url('Admin/daftar_pelaporan');?>">Semua</a>
                        <?php
                        foreach($angkatan as $a) {
                        ?>
                        <a class="collapse-item" href="<?= base_url('Admin/pelaporan_angkatan');?>/<?=$a->angkatan?>"><?=$a->angkatan?></a>
                        <?php } ?>
                    </div>
                </div>
            </li>
