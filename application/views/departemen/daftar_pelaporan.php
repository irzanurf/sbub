                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    foreach($view as $v) { 
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $v->angkatan ?></td>
                                            <td>
                                                <form style="display:inline-block;" method="get" action="<?= base_url('Departemen/akademik');?>">
                                                ...
                                                <form style="display:inline-block;" method="get" action="<?= base_url('Departemen/pribadi');?>">
                                                <input type='hidden' name="nim" value="<?= $v->nim ?>">
    ...
    <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form role="form" method="post" action="<?= base_url('Admin/tambah_mhs');?>">
                ...
                <input type="date" name="tgl_lahir" class="form-control" value="" required><br>
                <label>Alamat</label>
